    ...
    <section id="contact" className="py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="mb-12 text-center">
          <h2 className="mb-4 text-3xl font-bold text-amber-600 md:text-4xl">Contact</h2>
          <div className="mx-auto mb-8 h-1 w-24 rounded-full bg-amber-500"></div>
          <p className="mx-auto max-w-3xl text-lg text-neutral-700">
            Get in touch with us for orders, inquiries, or to learn more about our sweet fruity
            candies.
          </p>
        </div>
        ...
        <div className="mt-16">
          <div className="overflow-hidden rounded-xl bg-white shadow-md">
            ...
            <div className="p-6 text-center">
              ...
              <h3 className="mb-2 text-xl font-bold text-neutral-800">Factory Location</h3>
              <p className="mb-4 text-neutral-600">
                RANI AGRO FOOD, Dhanoli Road Darbada Th Salekasa , 441916 MH
              </p>
              <a
                href="https://www.google.com/maps?q=21.311496,80.440369"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 rounded-full bg-amber-500 px-4 py-2 text-white transition-colors duration-300 hover:bg-amber-600"
              >
