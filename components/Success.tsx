...
export default function Success({ success, setSuccess }: SuccessProps) {
  ...
  return (
    ...
    >
      <div
        className={`relative mx-4 w-full max-w-md rounded-xl bg-white shadow-2xl transition-all duration-300 ${
          isVisible ? 'scale-100 opacity-100' : 'scale-95 opacity-0'
        }`}
      >
        <button
          onClick={handleClose}
          className="absolute right-4 top-4 p-1 text-neutral-500 transition-colors hover:text-neutral-800"
