export const data = {
  ...
  description:
    'Manufacturers of natural fruit products including Tutti-Fruity, Karonda Cherry, Mahua Concentrate & fruit pulps. ISO-certified quality since 1995',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'ISO-certified manufacturers of Tutti-Fruity, Karonda Cherry, Mahua Concentrate & premium fruit products since 1995.',
